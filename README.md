...
simple CI/CD pipeline in Jenkins to automate deployment of a static website. also added webhook option to trigger changes to jenkins pipeline to deploy it on website
